<template>
    ...
    <form>
      ...
      <div>
        ...
        <p v-if="!isEdit">
          {{ user.doctor_profile.desk }}
        </p>
        <input v-else placeholder="" type="text" name="city" v-model="user.doctor_profile.desk"/>
      </div>
      <div>
        <label>
          Maximum des patient/jour
        </label>
        <p v-if="!isEdit">
          {{ user.doctor_profile.maxPatient }}
        </p>
        <input v-else placeholder="" type="text" name="wilaya" v-model="user.doctor_profile.maxPatient"/>
      </div>
      ...
      <div>
        ...
        <p v-if="!isEdit">
          {{ user.doctor_profile.price }}
        </p>
        <input v-else placeholder="" type="text" name="address" v-model="user.doctor_profile.price"/>
      </div>
    </form>
      ...
      methods:{
        async fetchpatientInfo(){
          try{
            ...
            this.user.doctor_profile.desk=data.infos.doctor_profile.desk;
            this.user.doctor_profile.maxPatient=data.infos.doctor_profile.maxPatient;
            this.user.doctor_profile.price=data.infos.doctor_profile.price;
          }catch(error){
            console.log(error)
          }
        },
